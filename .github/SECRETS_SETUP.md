...
| `DEPLOY_PATH_BACKEND` | Ścieżka do katalogu backendu | `/home/twoj-login/domains/api.proxeon.pl` |
| `DEPLOY_PATH_FRONTEND` | Ścieżka do katalogu frontendu | `/home/twoj-login/domains/proxeon.pl/public_html` |
